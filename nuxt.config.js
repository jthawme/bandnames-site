...
const PROJECT_TITLE = "Band Names";
const PROJECT_SHORT_TITLE = "Bandnames";
const PROJECT_DESCRIPTION =
  "A list of single word dictionary band names still available";
const PROJECT_KEYWORDS = "Band Name, Single word band names"; // add more
const PROJECT_DOMAIN = "https://bandnames.jthaw.club";
const GA_ID = "G-GC0WFQHZ8Q";
